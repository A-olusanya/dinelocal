...
<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-footer">
    <a href="login.php?logout=1" onclick="<?= htmlspecialchars("fetch('../logout.php')") ?>"><i class="bi bi-box-arrow-left"></i> Sign Out</a>
  </div>
</aside>
...
<div class="main">
  <div class="topbar">
    <h1>Manage Users</h1>
    <span style="font-size:.78rem;color:rgba(59,26,8,.5)">Logged in as: <?= htmlspecialchars($_SESSION['admin_username']) ?></span>
  </div>
